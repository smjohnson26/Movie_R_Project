...
Output for negative profit dataset using BIC:
  ...
  #R^2= 0.3643  
### Final Model
  The best assessment of profit is StepAICmodpos where AIC= 929.51 and R^2= 0.597. The final model has 3 more variables then its counter part using BIC but explains slightly more variance and has a lower AIC.
  ...
  A R^2 of 0.597 that the model does an adequate job of understand why a movie is profitable. However, there is room for improvement outside the scope of the dataset. 
