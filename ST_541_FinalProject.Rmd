...
top.companies.profit.infl.model <- lm(profit.infl~production.company)
...
significant_production_cos_profit.infl <- subset(movies_by_top_companies,summary(top.companies.profit.infl.model)$coeff[-1,4] < 0.05)
num_sig_comps_profit.infl <- count(significant_production_cos_profit.infl, vars = production.company)
ordered_run_profit.infl <- num_sig_comps_profit.infl[order(-num_sig_comps_profit.infl$n),]
head(ordered_run_profit.infl, n = 10)
```
